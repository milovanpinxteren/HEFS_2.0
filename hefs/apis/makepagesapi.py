...
class MakePagesAPI():
    def add_seo_pages(self):
        ...
        synoniemen_dict = {'Geniet': 'Genieten', 'onvergetelijk': 'memorabel', 'dit': 'deze',
                           'kerstfeest': 'kerstviering', 'speciaal': 'bijzonder', 'heerlijk': 'lekker',
                           'dierbaren': 'geliefden', 'assortiment': 'variatie', 'culinaire': 'culinair',
                           'hoogstandjes': 'specialiteiten', 'ingewikkelde': 'complex', 'focussen': 'richten',
                           'onvergetelijke': 'memorabele', 'huis': 'thuis', 'eenvoudig': 'makkelijk',
                           'eenvoudig': 'makkelijk', 'speciaal': 'bijzonder', 'heerlijk': 'lekker',
                           'hoogstandjes': 'specialiteiten', 'ingewikkelde': 'complexe', }

        id = 143092082
        count = 0
        title_dict = {1: 'Kerstdiner aan huis', 2: 'Kerstdiner bestellen', 3: 'Kerstbrunch aan huis',
                      4: 'Kerstbrunch bestellen', 5: 'Kerst catering', 6: 'Trateur kerst'}
        for place in places_array:
            tekst_nr = 0
            for tekst in seo_teksten_array:
                tekst_nr += 1
                general_tekst = tekst.replace('test', place)
                ...
                time.sleep(1)
                count += 1
                response = requests.post(url="https://d36867-2.myshopify.com/admin/api/2023-04/pages.json",
                                         headers=headers,
                                         json=payload)
