...
from hefs.models import Orders, NewOrders, VerzendOpties, AlgemeneInformatie


class Kerstdiner2025API:
    def __init__(self):
    ...
    def get_shopify_orders(self):
        ...
        while True:
            response = requests.post(
                url="https://d36867-2.myshopify.com/admin/api/2024-10/graphql.json",
                headers=headers,
