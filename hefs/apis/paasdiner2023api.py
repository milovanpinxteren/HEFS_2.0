...
from hefs.models import Orders, Orderline, NewOrders, ApiUrls


class Paasdiner2023API:
    def __init__(self):
        self.get_orders()
        self.clean_orders()
    ...
    def clean_orders(self):
        ...
        for orderline in range(0, len(self.new_orders)):
            ...
            existing_order = Orderline.objects.filter(order__conversieID=self.new_orders['ConversieId'][orderline],
