...
class CustomerInfo():
    def orders_per_date_plot(self, userid):
        ...
        data_2024 = JSONData.objects.get(key='data_2024').value
    ...
    def returning_customers_overview(self, userid):
        ...
        return customers_2020, customers_2021, customers_2022, customers_2023, returning_customers_2021, returning_customers_2022, returning_customers_21_22, returning_customers_2023
    ...
    def dinner_type_comparison(self, userid):
        ...
        distribution_2023 = JSONData.objects.get(key='distribution_2023').value
        aantal_hoofdgerechten = AlgemeneInformatie.objects.get(naam='aantalHoofdgerechten').waarde
        ...
        distribution_2024 = {"aantal personen": aantal_personen, "percentage brunch": percentage_brunch,
                             "aantal personen brunch": aantal_brunches
                             }
        return distribution_2022, distribution_2023, distribution_2024
    ...
    def prepare_view(self, userid):
        ...
        context = {'returning_customers_overview': returning_customers_overview,
                   ...
                   'customers_2023': returning_customers_overview[3],
                   'returning_customers_2021': returning_customers_overview[4],
                   'returning_customers_2022': returning_customers_overview[5],
                   'returning_customers_21_22': returning_customers_overview[6],
                   'returning_customers_2023': returning_customers_overview[7],
